...
get_header(); ?>
	...
	<?php while(have_posts()): the_post(); ?>
		<div class="content-container-anchor <?php if ( is_active_sidebar( 'homepage-widgets' ) ) : ?><?php else : ?>overlay-container-anchor<?php endif; ?>">
			<h2 class="title-anchor-home">Welcome To Windward Medispa!</h2>
				<?php the_content(); ?>
		...
		<div class="width-container">
			<div class="home-child-boxes grid3column ">
				<div class="content-container-anchor overlay-container-anchor">
					<center><a href="/register-to-win"><img src="/wp-content/uploads/reg2win_side.jpg"></a></center>
				</div>
			</div>
			<div class="home-child-boxes grid3column ">
				<div class="content-container-anchor overlay-container-anchor">
					<center><a href="/medispa-promotions"><img src="/wp-content/uploads/promo_side.jpg"></a></center>
				</div>
			</div>
			<div class="home-child-boxes grid3column lastcolumn">
				<div class="content-container-anchor overlay-container-anchor">
					<center><a href="/ask-a-specialist"><img src="/wp-content/uploads/aat_side.jpg"></a></center>
				</div>
			</div>
		</div>
